...
fn main() {
    ...
    //     std::println!("2024 Day 02 Part 1: {}", result.a);
    //     std::println!("2024 Day 02 Part 2: {}", result.b);
    // }

    {
        ...
        std::println!("2024 Day 03 Part 1: {}", result.a);
        std::println!("2024 Day 03 Part 2: {}", result.b);
    }
}
